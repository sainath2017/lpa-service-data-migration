...
@Setter
@ToString
public class PnrSetupCustomerDto {
  ...
  @CsvBindByName(column ="login_email_address")
 ...
 // @CsvCustomBindByName(column ="pnr_type", converter = CsvStringJsonToSetConverter.class)
